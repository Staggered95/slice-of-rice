...
() {
  ...
  typeset -g POWERLEVEL9K_MULTILINE_NEWLINE_PROMPT_SUFFIX='2422F─┤'
  ...
  #################################[ os_icon: os identifier ]##################################
  # OS identifier color.
  typeset -g POWERLEVEL9K_OS_ICON_FOREGROUND=120
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=28
  # Custom icon.
  ...
  typeset -g POWERLEVEL9K_DIR_BACKGROUND=157
  # Default current directory foreground color.
  typeset -g POWERLEVEL9K_DIR_FOREGROUND=28
  ...
  typeset -g POWERLEVEL9K_DIR_ANCHOR_FOREGROUND=28
  ...
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_BACKGROUND=191
  ...
  # Custom prefix.
  typeset -g POWERLEVEL9K_COMMAND_EXECUTION_TIME_PREFIX='in '

  #######################[ background_jobs: presence of background jobs ]#######################
  # Background jobs color.
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_FOREGROUND=28
  typeset -g POWERLEVEL9K_BACKGROUND_JOBS_BACKGROUND=191
